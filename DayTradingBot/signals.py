...
Signal:
  ...
  -- 2026-08-10 backtest (6mo and 12mo) showed SPY-anchored HTF turned several
  tickers (MU, TSLA) into net losers since single-stock moves don't track SPY
  intraday; self-anchor swung the strategy from -$2.7k/12mo to +$5.3k/12mo.
"""
import logging
...
def get_signal(symbol: str) -> dict:
    ...
    # HTF trend (own 15-min trend, not a shared SPY anchor -- see module docstring)
