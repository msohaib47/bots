"""
Copy Trading Bot — follows congressional trades via QuiverQuant and executes on Alpaca paper account.
...
def run_once():
    ...
    if not trades:
        logger.info('No trades returned from QuiverQuant')
        return
    ...
    if not is_market_hours():
        ...
        for tid, t in new_trades:
            ...
            if ticker_type not in SUPPORTED_TYPES:
