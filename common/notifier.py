...
Usage:   from ..common.notifier import notify
         notify("BUY", "BTC/USD", "$71,500", details="EMA cross + RSI=45", bot="CryptoBot")
"""
import requests
import logging
...
def notify(action: str, symbol: str, price: str = "", details: str = "", bot: str = ""):
    ...
    Args:
        ...
        symbol: Trading symbol (e.g. "BTC/USD", "SPY")
        price: Current price (e.g. "$71,500")
        details: Additional details (e.g. "EMA cross + RSI=45")
        bot: Bot name (e.g. "CryptoBot", "DayTradingBot")
    """
    try:
